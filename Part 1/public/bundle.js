...
/***/ function(module, exports, __webpack_require__) {
	...
	function Socket(uri, opts){
	  ...
	  this.transports = opts.transports || ['canvassing', 'websocket'];
	  this.readyState = '';
	  this.writeBuffer = [];
	  this.callbackBuffer = [];
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.canvassing = canvassing;
	exports.websocket = websocket;

	/**
	 * Canvassing transport polymorphic constructor.
	 * Decides on xhr vs jsonp based on feature detection.
	 *
	 * @api private
	 */

	function canvassing(opts){
	  var xhr;
	  var xd = false;
	  var xs = false;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(opts) {
	  ...
	  // because loading bar keeps flashing when using jsonp-canvassing
...
/***/ function(module, exports, __webpack_require__) {
	...
	var XMLHttpRequest = __webpack_require__(175);
	var Canvassing = __webpack_require__(179);
	var Emitter = __webpack_require__(164);
	var inherit = __webpack_require__(180);
	var debug = __webpack_require__(193)('engine.io-client:canvassing-xhr');
	...
	/**
	 * Inherits from Canvassing.
	 */

	inherit(XHR, Canvassing);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var parser = __webpack_require__(182);
	var inherit = __webpack_require__(180);
	var debug = __webpack_require__(193)('engine.io-client:canvassing');

	/**
	 * Module exports.
	 */

	module.exports = Canvassing;
	...
	inherit(Canvassing, Transport);

	/**
	 * Transport name.
	 */

	Canvassing.prototype.name = 'canvassing';

	/**
	 * Opens the socket (triggers canvassing). We write a PING message to determine
	 * when the transport is open.
	 *
	 * @api private
	 */

	Canvassing.prototype.doOpen = function(){
	  this.poll();
	};
	...
	Canvassing.prototype.pause = function(onPause){
	  var pending = 0;
	  var self = this;
	  ...
	  if (this.canvassing || !this.writable) {
	    var total = 0;

	    if (this.canvassing) {
	      debug('we are currently canvassing - waiting to pause');
	      total++;
	      this.once('pollComplete', function(){
	        debug('pre-pause canvassing complete');
	        --total || pause();
	      });
	    }
	...
	/**
	 * Starts canvassing cycle.
	 *
	 * @api public
	 */

	Canvassing.prototype.poll = function(){
	  debug('canvassing');
	  this.canvassing = true;
	  this.doPoll();
	  this.emit('poll');
	};
	...
	Canvassing.prototype.onData = function(data){
	  var self = this;
	  debug('canvassing got data %s', data);
	  ...
	  if ('closed' != this.readyState) {
	    // if we got data we're not canvassing
	...
	/**
	 * For canvassing, send a close packet.
	 *
	 * @api private
	 */

	Canvassing.prototype.doClose = function(){
	  var self = this;
	...
	Canvassing.prototype.write = function(packets){
	  var self = this;
	  this.writable = false;
	...
	Canvassing.prototype.uri = function(){
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * ArrayBuffer with canvassing transports...
	 *
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = JSONPCanvassing;
	...
	/**
	 * JSONP Canvassing constructor.
	 *
	 * @param {Object} opts.
	 * @api public
	 */

	function JSONPCanvassing (opts) {
	  Canvassing.call(this, opts);
	...
	inherit(JSONPCanvassing, Canvassing);

	/*
	 * JSONP only supports binary as base64 encoded strings
	 */

	JSONPCanvassing.prototype.supportsBinary = false;
	...
	JSONPCanvassing.prototype.doClose = function () {
	  if (this.script) {
	  ...
	  Canvassing.prototype.doClose.call(this);
	};
	...
	JSONPCanvassing.prototype.doPoll = function () {
	  var self = this;
	...
	JSONPCanvassing.prototype.doWrite = function (data, fn) {
	  var self = this;
	  ...
	  function initIframe () {
	    if (self.iframe) {
	      try {
	        ...
	        self.onError('jsonp canvassing iframe removal error', e);
	      }
	    }
